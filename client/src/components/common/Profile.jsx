...
const Profile = () => {
    ...
    // Define field structure for student and staff
    const studentFields = ["name", "course", "semester", "department", "fatherName", "motherName", "dob", "contact", "address", "email"];
    const staffFields = ["uniqueId","name", "coordinatorFor", "designation", "fatherName", "motherName", "dob", "contact", "email", "address"];

    // Determine field order based on role
                        ...
                        <div key={key} className="flex uppercase justify-between items-center border-b pb-3">
                            ...
                            <div className="flex space-x-3">
                                {editingField === key ? (
                                    ...
                                    !["course", "semester", "name", "department", "uniqueId", "coordinatorFor"].includes(key) && (
                                        <button
